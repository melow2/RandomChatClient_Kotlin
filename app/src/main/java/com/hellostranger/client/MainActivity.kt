...
class MainActivity : BaseActivity<MainActivityBinding>() {
    ...
    private fun init() {
        ...
        eventHandler.addEventListener(object : MainHandler.MainHandlerEvent {
    ...
    private fun setPopupAd() {
        val closeDialog = CloseDialog(mContext = this);
    ...
    private fun setPopupSex() {
        ...
        selectSexDialog.addButtonListener(object : SelectSexDialog.Event {
            @Suppress("DEPRECATION")
    ...
    private fun addView(msg: String, i: Int) {
        mWeakHandler.post {
            mBinding.lytMsgline.addView(RandomChatLog(this@MainActivity, mBinding, msg, null, i))
